        ...
        <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
          <div className="mb-4 flex justify-between">
            <h2 className="text-xl font-semibold">
              Total Income: {incomeAmount !== null ? `${incomeAmount} ${currency}` : "Loading..."}
            </h2>
            ...
            <div className="dropdown dropdown-bottom dropdown-end transition-all">
              ...
              <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-1 w-40 p-2 shadow-lg">
          ...
          <div className="mb-2">
            <h2 className="text-xl font-semibold">
              Remain Income: {remainIncome !== null ? `${remainIncome} ${currency}` : "Loading..."}
            </h2>
          </div>

          <div className="mb-4">
            <h2 className="text-xl font-semibold">Total Expenses: {totalExpenses} {currency}</h2>
          </div>
